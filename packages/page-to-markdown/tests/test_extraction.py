...
def test_main_confidence_report_renders_aligned_rows(capsys, monkeypatch) -> None:
	...
	assert "× Verdict              low-confidence" in captured.out
...
def test_main_returns_failure_without_output_when_all_sources_fail(
	tmp_path, capsys
) -> None:
	missing_sources = [
