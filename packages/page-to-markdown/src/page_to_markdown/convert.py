...
BLOCK_TAGS = frozenset(
    [
        "address", "article", "blockquote", "body", "dd", "details", "div",
        "dl", "dt", "figure", "figcaption", "h1", "h2", "h3", "h4", "h5",
        "h6", "head", "hr", "html", "li", "main", "ol", "p", "pre", "section",
        "summary", "table", "ul",
    ]
)
...
def _render_table(node: _DomNode, base_url: str | None) -> str:
    ...
    lines = [_format_table_row(padded_rows[0]), _format_table_row(["---"] * column_count)]
